...
//   // Handle skill input (comma-separated)
...
//             className="border border-gray-300 rounded-lg px-3 py-2 text-gray-700 bg-white shadow-sm hover:border-blue-400 focus:ring-2 focus:ring-blue-400 transition"
//           >
//             {categories.map((cat) => (
...
//                   })
//                 }
//                 className="w-full border rounded-lg px-3 py-2 h-24 focus:ring-2 focus:ring-blue-400 outline-none"
//                 required
//               />
//               <input
//                 type="text"
...
//                     })
//                   }
//                   className="w-1/2 border rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-400"
//                 >
